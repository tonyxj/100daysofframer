#Project Info
Framer.Info =
	title: "Rebound of Wine Shop Cart"
	author: "Tony Jing (Original: Anadea Inc)"
	twitter: "TonyJing"
	description: "An another approach for the UX of Anadea Inc's prototype. Visual and UI design are done Anadea Inc. They are re-used here for learning purposes only."
...
puff = new Animation 
	layer: smoke
	properties: scale: 1.7, opacity: 0
	curve: "ease-out"
	time: 0.5
